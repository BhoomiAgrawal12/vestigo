...
class FeatureExtractionService:
    ...
    async def _run_real_ghidra_analysis(self, binary_path: str, workspace_dir: str, job_id: str) -> Dict[str, Any]:
        ...
        # extract_features.py script outputs to ghidra_json/BINARY_NAME_features.json
        # Pass project root so script knows where to create output directory
        ...
        ghidra_cmd = [
            ...
            "-postScript", self.extract_features_script.name, project_root,  # Run extract_features.py
        ...
        try:
            ...
            # Script saves to: ghidra_json/BINARY_NAME_features.json
